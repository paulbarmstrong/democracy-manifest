...
import { WORKER_SIZE_PX } from "../utilities/Constants"
	...
	return <div style={{position: "relative"}}>
		{
			props.worker.class !== "Machine" ? (
				<div style={{position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: WORKER_SIZE_PX, height: WORKER_SIZE_PX, backgroundColor: getWorkerColor(props.worker), borderRadius: props.worker.class === "Working Class" ? "50%" : 4, borderWidth: 2, borderColor: "white", borderStyle: "solid"}}/>
			) : (
				undefined
			)
		}
